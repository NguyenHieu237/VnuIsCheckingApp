...
import com.example.snap_time_picker.databinding.LayoutSnapTimePickerDialogBinding
import com.example.snap_time_picker.extension.SnapTimePickerViewModel
        ...
        override fun onScrollStateChanged(recyclerView: RecyclerView, newState: Int) {
            ...
            if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                ...
                hourSnappedView?.let { view ->
                    ...
                    hourAdapter.updatePositionSelected(positionSelected = hourLayoutManager.getPosition(view))
                }
        ...
        override fun onScrollStateChanged(recyclerView: RecyclerView, newState: Int) {
            ...
            if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                ...
                minuteSnappedView?.let { view ->
                    ...
                    minuteAdapter.updatePositionSelected(positionSelected = hourLayoutManager.getPosition(view))
                }
    ...
    private fun useLiveDataAsCallback() {
        activity?.let {
            val viewModel: SnapTimePickerViewModel =
                ViewModelProvider(this)[SnapTimePickerViewModel::class.java]
            this.listener = object : Listener {
                override fun onTimePicked(hour: Int, minute: Int) {
