...
class QRResultEmailView : BaseCustomViewLinearLayout {
    ...
    private val txtEmailView: TextView by lazy {
    ...
    override val layoutId: Int
        get() = R.layout.layout_result_qr_email

    fun setContent(
        email: String?
    ) {
        txtEmailView.text = email
        init()
    }
    ...
    private fun init() {
        ...
        layout.findViewById<LinearLayout>(R.id.copy).setOnClickListener {
            copyToClipboard(txtEmailView.text.toString())
        }
    ...
    private fun composeEmail() {
        ...
        intent.data = Uri.parse("mailto:" + txtEmailView.text.toString()) // only email apps should handle this
