...
class QRCodeBarEAN13 : BaseCustomViewLinearLayout {
    ...
    private fun setupUI() {
        ...
        viewBarCode.countCharacter(13, invalid)
        viewBarCode.setHint(context.getString(R.string.hint_ean13))
    ...
    fun generateQRCode() {
        if (QRCodeManager.isValidEANandUCP(viewBarCode.getContent())) {
            val result = QRCodeManager.instance().generateBarEAN13Code(
            ...
            Toast.makeText(
                this.context,
                context.getString(R.string.invalid_form_ean13),
                Toast.LENGTH_SHORT
            ).show()
            return
        }
    ...
    private val mTextEditorWatcher: TextWatcher = object : TextWatcher {
        ...
        override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
            if(viewBarCode.edtContent.length() == 13){
