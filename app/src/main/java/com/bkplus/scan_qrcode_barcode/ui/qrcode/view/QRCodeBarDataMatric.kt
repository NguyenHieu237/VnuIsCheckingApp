...
class QRCodeBarDataMatric : BaseCustomViewLinearLayout {
    ...
    private fun setupUI() {
        ...
        viewBarCode.setHint(context.getString(R.string.hint_data_matrix))
    ...
    fun generateQRCode() {
        ...
        onGenerateQRCodeCompletion?.invoke(
            QRCodeManager.instance().generateBarDataMatricCode(viewBarCode.getContent())
        )
    }
